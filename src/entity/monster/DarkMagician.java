...
{
    public DarkMagician(GamePanel gp)
    {
        super(gp);
        setImgHeight(32);
        setImgWidth(32);
        ...
        setDefaultValues();
        getDarkMagicianImage();
    }

    public void setDefaultValues()
    {
        setName("Dark Magician");
        setType("Common");
    ...
    public void getDarkMagicianImage()
    {
        String txt = "/monster/32x32/darkmagician/dark_magician";
        down1 = setup(txt + " 1");
        down2 = setup(txt + " 2");
        down3 = setup(txt + " 3");
        left1 = setup(txt + " 4");
