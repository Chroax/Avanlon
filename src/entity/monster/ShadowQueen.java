...
public class ShadowQueen extends Monster
{
    public ShadowQueen(GamePanel gp)
    {
        super(gp);
        setImgHeight(64);
        setImgWidth(64);
    ...
    public void getShadowQueenImage()
    {
        String txt = "/monster/64x64/shadowqueen/shadow_queen";
        down1 = setup(txt + " 1");
        down2 = setup(txt + " 2");
        down3 = setup(txt + " 3");
        left1 = setup(txt + " 4");
