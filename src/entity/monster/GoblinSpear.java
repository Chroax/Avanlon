...
public class GoblinSpear extends Monster
{
    public GoblinSpear(GamePanel gp)
    {
        super(gp);
        setImgHeight(32);
        setImgWidth(32);
    ...
    public void getGoblinSpearImage()
    {
        String txt = "/monster/32x32/goblinspear/goblin_spear";
        down1 = setup(txt + " 1");
        down2 = setup(txt + " 2");
        down3 = setup(txt + " 3");
        left1 = setup(txt + " 4");
