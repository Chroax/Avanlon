...
public class PurpleArima extends Monster
{
    public PurpleArima(GamePanel gp)
    {
        super(gp);
        setImgHeight(48);
        setImgWidth(48);
    ...
    public void getPurpleArimaImage()
    {
        String txt = "/monster/48x48/purplearima/purple_arima";
        down1 = setup(txt + " 1");
        down2 = setup(txt + " 2");
        down3 = setup(txt + " 3");
        left1 = setup(txt + " 4");
