...
public class PrimeMinister extends Entity
{
    public PrimeMinister(GamePanel gp)
    {
        super(gp);

        setName("Prime Minister");
        setDirection("down");
        setImgWidth(32);
        setImgHeight(48);
        ...
        getPrimeMinisterImage();
        setDialogue();
    }

    public void getPrimeMinisterImage()
    {
        String txt = "/npc/32x48/primeminister/prime_minister";
