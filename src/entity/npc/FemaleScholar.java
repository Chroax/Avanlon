...
public class FemaleScholar extends Entity
{
    public FemaleScholar(GamePanel gp)
    {
        super(gp);

        setName("Female Scholar");
        setDirection("down");
        setImgWidth(32);
        setImgHeight(48);
        ...
        getFemaleScholarImage();
        setDialogue();
    }

    public void getFemaleScholarImage()
    {
        String txt = "/npc/32x48/femalescholar/female_scholar";
