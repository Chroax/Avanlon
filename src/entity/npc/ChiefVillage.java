...
public class ChiefVillage extends Entity
{
    public ChiefVillage(GamePanel gp)
    {
        super(gp);

        setName("Chief Village");
        setDirection("down");
        setImgWidth(32);
        setImgHeight(48);
        ...
        getChiefVillageImage();
        setDialogue();
    }

    public void getChiefVillageImage()
    {
        String txt = "/npc/32x48/chiefvillage/chief_village";
